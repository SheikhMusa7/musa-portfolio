  ...
  const pillars = [
    {
      ...
      description: "B.Tech CSE at SSM College of Engineering, building the theoretical foundation that backs every practical system I ship.",
    ...
    },
    {
      ...
      description: "Full-stack Python developer with deep expertise in AI, automation pipelines, and web platforms that solve real business problems.",
    ...
    },
    {
      ...
      subtitle: "Aspiring Entrepreneur",
      description: "Every project, every line of code is a step toward launching a technology business that redefines how enterprises integrate intelligence.",
