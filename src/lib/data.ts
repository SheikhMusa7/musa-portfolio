...
export const visionServices = [
  {
    ...
    description: "Custom AI pipelines that eliminate repetitive work, automate decision-making, and scale operations without headcount growth.",
    icon: "⚙️",
  },
  {
  ...
  },
  {
    ...
    description: "Strategic integration of LLMs, computer vision, and predictive models into existing business workflows.",
    icon: "🧩",
  },
  {
...
export const footballValues = [
  {
    title: "Discipline",
    description: "Consistent daily practice, preparation, and recovery. The same system that builds a footballer builds an entrepreneur.",
    icon: "🎯",
  },
  {
    title: "Teamwork",
    description: "No one builds a company alone. Football taught me how to communicate clearly, trust my team, and execute together under pressure.",
    icon: "🤝",
  },
  {
    title: "Leadership",
    description: "Taking responsibility for outcomes, making decisions in real-time, and elevating everyone around you.",
    icon: "⚡",
  },
  {
